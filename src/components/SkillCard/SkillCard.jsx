...
const SkillCard = ({ delay = 0, left, name, image, topColor, bottomColor }) => {
    ...
    return (
        <div ref={card} className='w-52 h-64 p-3 rounded-2xl absolute card text-2xl font-semibold text-white text-center hover:scale-105 transition-all duration-300 ease-in-out'>
            <img className='mb-2 h-5/6' src={require(`.././assets/logos/${image}`)} alt='not loaded' />
